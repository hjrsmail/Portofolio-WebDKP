...
<body>
    ...
    <main>
        <div class="container py-4">
            ...
            <p><small class="text-muted">{{ \Carbon\Carbon::parse($berita->date)->format('d M Y') }}</small></p>

            @if ($berita->image)
                <img src="{{ asset('storage/' . $berita->image) }}" alt="Gambar Berita" class="img-fluid rounded mb-4">
            @else
